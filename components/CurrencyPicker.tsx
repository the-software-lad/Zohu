...
const CurrencyPicker = ({visible, selectedCode, onSelect, onClose}:{visible:boolean; selectedCode:string; onSelect:(currency: CurrencyEntry)=>void; onClose: ()=> void})=>{
            ...
            <SafeAreaView className="flex-1 bg-brand-body" edges={["top"]}>
                <View className="flex-row items-center px-5 pt-3 pb-2 gap-3">
                    <TextInput
                        ...
                        autoFocus
                        className="flex-1 bg-white border border-[#E8E6DF] rounded-full px-4 py-2.5 text-sm tex-brand-bg"
                    />
                    <TouchableOpacity
                        onPress={()=>{
                            setSearch("");
                ...
                <FlatList 
                    ...
                    renderItem={({item})=>(
                        <TouchableOpacity
                            ...
                            className="flex-row items-center px-5 py-3.5 birder-b border-[#F0EDE6]"
                        >
